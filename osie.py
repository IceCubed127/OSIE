    ...
    if choice == '1':
        ...
        if win_choice == '1':
            ...
            if lang_choice in lang:
                ...
                webbrowser.open(url)
                print("Note: If the download destination is not your downloads folder, please cancel the download and move it there else the program fails to detect file.")
                print(f"Downloading Windows XP Service Pack 3 in {lang_choice[0]}...")
